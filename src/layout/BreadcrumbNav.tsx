...
export const BreadcrumbNav: React.FC<BreadcrumbNavProps> = React.memo(({ flatNodes, breadcrumbIds, onNavigate }) => {
  ...
  return (
    <div className='flex items-center gap-1.5 overflow-x-auto py-2 px-6 bg-surface/30 border-b border-surface-border scrollbar-none text-xs'>
      {canGoBack && parentId !== null && (
        <Button variant='outline' size='icon' onClick={() => onNavigate(parentId)} title='Back to parent folder'>
